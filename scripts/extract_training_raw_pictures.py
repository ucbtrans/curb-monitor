...
def run(weights='yolov5s.pt',  # model.pt path(s)
        ...
        nosave=True,  # do not save detected images/videos
        ...
        sample_interval=1, #Detected picture sample interval. i.e. sample detect objects picture once per x pictures, set to 1 if not sample
    ...
    for path, img, im0s, vid_cap in dataset:
        ...
        for i, det in enumerate(pred):  # per image
            ...
            save_original_path = str(save_dir / 'images' / p.stem) + ('' if dataset.mode == 'image' else f'_{frame}')  # f_frame.jpg
            ...
            if save_orginal_image and should_save_org_img:
                ...
                if sample_count % sample_interval == 0:
                    cv2.imwrite(save_original_path + '.jpg', original_img)
...
def parse_opt():
    ...
    parser.add_argument('--sample-interval', type=int, default=15, help='detected picture sample interval. i.e. sample detect objects picture once per x pictures, set to 1 if not sample')
