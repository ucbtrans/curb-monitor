...
# run job
cd ~/curb-monitor && python ./scripts/detect_objects.py --save-csv --class 1 3 4 5 6 --conf-thres 0.25 --img 640  --weights ./models/curb_prod_model/weights/best.pt --source $VIDEOS_ABS_PATH